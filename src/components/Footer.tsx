        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
          ...
          <div className="flex items-center justify-end gap-4">
            <a
              ...
              className="w-9 h-9 bg-slate-900 hover:bg-slate-800 rounded-full flex items-center justify-center transition-colors duration-200"
              aria-label="GitHub"
            >
              <svg className="w-5 h-5 text-slate-300 hover:text-rose-400" fill="currentColor" viewBox="0 0 24 24">
